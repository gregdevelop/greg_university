<x-page-template bodyClass='g-sidenav-show  bg-gray-200'>
    <x-auth.navbars.sidebar activePage='pages' activeItem='projects' activeSubitem='general'></x-auth.navbars.sidebar>
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-auth.navbars.navs.auth pageTitle='General'></x-auth.navbars.navs.auth>
        <!-- End Navbar -->
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-6 col-md-6 col-12 mt-4 mt-lg-0">
                            <div class="card">
                                ...
                                <hr class="dark horizontal my-0">
                                <div class="card-footer p-3">
                                    <p class="mb-0"><span class="text-danger text-sm font-weight-bolder">-5% </span>than
                                        lask week</p>
                                </div>
                            </div>
                        </div>
