<x-page-template bodyClass='g-sidenav-show  bg-gray-200'>
    ...
    <x-auth.navbars.sidebar activePage="pages" activeItem="charts" activeSubitem=""></x-auth.navbars.sidebar>
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-auth.navbars.navs.auth pageTitle="Charts"></x-auth.navbars.navs.auth>
        <!-- End Navbar -->
