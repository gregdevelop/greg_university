<x-page-template bodyClass='g-sidenav-show  bg-gray-200'>
    ...
    <x-auth.navbars.sidebar activePage='pages' activeItem='users' activeSubitem='reports'></x-auth.navbars.sidebar>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-12 mb-4">
                            <div class="card">
                                ...
                                <hr class="dark horizontal my-0">
                                <div class="card-footer p-3">
                                    <p class="mb-0"><span class="text-success text-sm font-weight-bolder">+124%
                                        </span>than lask week</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-lg-6 col-md-6 col-12 mt-4 mt-md-0">
                            <div class="card">
                                ...
                                <hr class="dark horizontal my-0">
                                <div class="card-footer p-3">
                                    <p class="mb-0"><span class="text-success text-sm font-weight-bolder">+90%
                                        </span>than lask week</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-xxs font-weight-bolder opacity-7 ps-2">Function
                                        </th>
                                        <th class="text-uppercase text-xxs font-weight-bolder opacity-7 ps-2">Review
                                        </th>
                                        <th class="text-center text-uppercase text-xxs font-weight-bolder opacity-7">
                                            Email</th>
                                        <th class="text-center text-uppercase text-xxs font-weight-bolder opacity-7">
                                            Employed</th>
                                        <th class="text-center text-uppercase text-xxs font-weight-bolder opacity-7">Id
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
